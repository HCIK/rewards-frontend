...
const CountdownTimer = () => {
  ...
  return (
    <div>
      ...
      <p className='text-4 leading-2 font-montserrat text-white-2 text-center mt-5'><span className='font-bold text-white-main'>{day}</span> days : <span className='font-bold text-white-main'>{hour}</span> hours : <span className='font-bold text-white-main'>{min}</span> minutes : <span className='font-bold text-white-main'>{sec}</span> seconds
